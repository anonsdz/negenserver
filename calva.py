...
TOKEN, ADMIN_ID, GROUP_ID, VIP_USERS_FILE, METHODS_FILE, user_processes = '7534359784:AAFLpxOQQrRf8SMCBycRT6BwCr5Cqf6g0xs', 7371969470, -1002411881962, 'vip_users.json', 'methods.json', {}
...
async def help_message(update, context):
    await update.message.reply_text("[👑Owner👑 Calvados ❄️] Buy BOT theo Tuần/Tháng Build BOT server riêng biệt contact @jonhhaha @yeuem111233:**\n\n"
